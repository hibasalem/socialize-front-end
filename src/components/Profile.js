  ...
  return (
    <div className="mainDiv">
      ...
      <h2 className="profileName">
        <Image src={props.user.image_url} roundedCircle height="70px" />
        &nbsp; &nbsp;
            ...
            return (
              <>
                ...
                <button
                  ...
                  onClick={() => props.handleShowMessenger(item.id)}
                >
                  Chat
                </button>
              </>
